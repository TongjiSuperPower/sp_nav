...
def global_localization(pose_estimation):
    ...
    if fitness > LOCALIZATION_TH:
        ...
        bool_msg = Bool()
        bool_msg.data = True
        localization_success_pub.publish(bool_msg)
        return True
    else:
...
if __name__ == '__main__':
    ...
    localization_success_pub = rospy.Publisher('/localization_success', Bool, queue_size=1)
    ...
    initialize_global_map(rospy.wait_for_message('/3dmap', PointCloud2))
